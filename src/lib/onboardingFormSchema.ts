export const onboardingFormSchema = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'previous_org_1_service_period_from_epm', label: 'Previous Org 1 Service Period From', type: 'date' },
      { name: 'previous_org_1_service_period_to_epm', label: 'Previous Org 1 Service Period To', type: 'date' },
      { name: 'previous_org_1_reason_of_leaving_epm', label: 'Previous Org 1 Reason for Leaving', type: 'textarea' },
      ...
      { name: 'previous_org_2_service_period_from_epm', label: 'Previous Org 2 Service Period From', type: 'date' },
      { name: 'previous_org_2_service_period_to_epm', label: 'Previous Org 2 Service Period To', type: 'date' },
      { name: 'previous_org_2_reason_of_leaving_epm', label: 'Previous Org 2 Reason for Leaving', type: 'textarea' },
      ...
      { name: 'previous_org_3_service_period_from_epm', label: 'Previous Org 3 Service Period From', type: 'date' },

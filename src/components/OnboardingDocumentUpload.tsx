        ...
        >
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="mt-6">
                <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Uploaded Files</h4>
                {uploadedFiles.length === 0 ? (
                  <p className="text-sm text-gray-500 dark:text-gray-400">No files uploaded yet for this type.</p>
                ) : (
                  <ul className="border border-gray-200 dark:border-gray-700 rounded-md divide-y divide-gray-200 dark:divide-gray-700">
                    {uploadedFiles.map((file, index) => (
                      <li key={index} className="px-4 py-2 flex items-center justify-between">
                        ...
                        {/* Add download or delete options here if needed */}
                      </li>
                    ))}
                  </ul>
                )}

...
export default function MasterAdminOrgChartPage() {
  ...
  const fetchOrgChart = useCallback(async () => {
    ...
    try {
      const result = await callPgFunction(
        HMS_GATEWAY_CONFIGS.ORG_CHART_MASTER_ADMIN,
        {},
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">Overview of the organizational hierarchy.</p>
            </div>
          </div>

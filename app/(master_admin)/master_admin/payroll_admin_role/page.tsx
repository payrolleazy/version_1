...
export default function PayrollAdminRolePage() {
  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Assign Payroll Admin Role</h1>
      ...
      <UserRolesDataTable 
        roles={roles.filter(role => role.role === 'payroll_admin')}
        onEdit={() => {}}
        onToggleEnable={() => {}}
